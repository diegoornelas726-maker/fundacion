...
<div class="wrapper">
    ...
    <div class="card">
        ...
        <p class="card-desc">Crea una contraseña segura para tu cuenta.</p>
        ...
        <form method="POST" action="{{ route('password.store') }}">
            ...
            <!-- Email (oculto visualmente pero necesario para Laravel) -->
            <div class="field">
...
<script>
    function updateStrength(val) {
        ...
        label.style.color = val.length > 0 ? colors[score - 1] : '#3f3f46';
    }
</script>
</body>
</html>